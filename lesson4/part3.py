...
# show the images
new_img = np.vstack((r_img1,r_img2,r_img3))        #  np.vstack is the function of numoy which is used to store things in horizotal format ; v represnt vertical
